      ...
      >
        <div className="grid gap-6 sm:grid-cols-2">
          <div className="flex flex-col gap-2">
            ...
            <Input id="nom" name="nom" required className="h-12 rounded" />
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <Input id="code" name="code" required className="h-12 rounded" />
          </div>
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end">
            ...
            <div className="flex w-full flex-col gap-2 sm:w-[7.5rem] sm:shrink-0">
              ...
              <Input id="unite" name="unite" className="h-12 rounded" />
            </div>
          </div>
