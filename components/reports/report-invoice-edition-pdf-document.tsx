...
import { REPORT_INVOICE_EDITION_PDF_LABELS } from "@/lib/reports/report-invoice-edition-pdf-labels";
...
const labels = REPORT_INVOICE_EDITION_PDF_LABELS;
...
export function ReportInvoiceEditionPdfDocument({ content }: Props) {
    const p = content;
                ...
                {p.lineItems.length > 0 ? (
                    p.lineItems.map((row) => (
                        ...
                        >
                            ...
                            <TableCell width={COL.taxAmount} align="right">
                                {row.taxAmount}
                            </TableCell>
                            <TableCell width={COL.paidAmount} align="right">
                                {row.paidAmount}
                            </TableCell>
                            <TableCell width={COL.totalAmount} align="right">
                                {row.totalAmount}
                            </TableCell>
                            <TableCell width={COL.currency}>
                                {row.currency}
                            </TableCell>
                            <TableCell width={COL.invoiceType}>
                                {row.invoiceType}
                            </TableCell>
                            <TableCell width={COL.dueDate} align="right">
                                {row.dueDate}
                            </TableCell>
                        </View>
                    ))
