...
import type { VatCollectionPreviewContent } from "@/core/types/reports";
...
export function ReportVatCollectionPreview({ content }: Props) {
    const t = useTranslations("reports.preview.vatCollection");
    const p = content;
